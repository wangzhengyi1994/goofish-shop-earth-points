<template>
  <div class="large-screen">
    ...
    <div class="large-screen-wrap" id="large-screen">
      <m-header title="浙江省数据发布平台" sub-text="shnxi Data visualization">
        <!--左侧 天气 -->
        ...
        <template v-slot:right>
          <div class="m-header-date"><span>2025-7-19</span><span>13:40:19</span></div></template
        >
      </m-header>
      <!-- 顶部菜单 -->
      <div class="top-menu">
        <mMenu :default-active="state.activeIndex" @select="handleMenuSelect">
          <mMenuItem index="1">财富概览</mMenuItem>
          <mMenuItem index="2">navigation1</mMenuItem>
          <mMenuItem index="3">navigation2</mMenuItem>
          <div class="top-menu-mid-space"></div>
          <mMenuItem index="4">navigation3</mMenuItem>
          <mMenuItem index="5">navigation4</mMenuItem>
          <mMenuItem index="6">navigation5</mMenuItem>
        </mMenu>
      </div>
      <!-- 顶部统计卡片 -->
      ...
      <div class="bottom-tray">
        ...
        <div class="bottom-menu">
          <div class="bottom-menu-item is-active"><span>常驻概览</span></div>
          <div class="bottom-menu-item"><span>title1</span></div>
          <div class="bottom-menu-item"><span>title2</span></div>
          <div class="bottom-menu-item"><span>title3</span></div>
        </div>
        <!-- 右箭头 -->
  ...
  totalView: [
    {
      icon: "xiaoshoujine",
      zh: "xxxx年生产总值",
      en: "Gross Domestic Product in xxxx",
      value: 12345,
      unit: "亿元",
    },
    {
